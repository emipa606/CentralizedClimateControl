        ...
        public void PrintForGrid(SectionLayer layer, AirFlowType type)
        {
            switch (type)
            {
                case AirFlowType.Hot:
                    GraphicsLoader.GraphicHotPipeOverlay.Print(layer, parent, 0f);
                    break;

                case AirFlowType.Cold:
                    GraphicsLoader.GraphicColdPipeOverlay.Print(layer, parent, 0f);
                    break;

                case AirFlowType.Frozen:
                    GraphicsLoader.GraphicFrozenPipeOverlay.Print(layer, parent, 0f);
                    break;
